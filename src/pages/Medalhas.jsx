...
const medalhasData = [
  ...
  {
    id: 2,
    nome: "Esforço constante",
    emoji: "🥈",
    corBg: "bg-gray-700",
    corBorder: "border-gray-600",
    textoCor: "text-gray-400",
    descricao:
      "Essa medalha simboliza sua dedicação contínua em melhorar a cada dia, mesmo nos momentos difíceis.",
    desbloqueada: false,
  },
  {
    id: 3,
    ...
    textoCor: "text-gray-400",
    descricao:
      "Essa medalha é para quem sabe se levantar após cada queda, mostrando resiliência e força interior.",
    desbloqueada: false,
  },
  {
    id: 4,
    ...
    textoCor: "text-gray-400",
    descricao:
      "Você começou uma nova jornada e já está conquistando seus primeiros objetivos!",
    desbloqueada: false,
  },
  {
    id: 5,
    ...
    textoCor: "text-gray-400",
    descricao:
      "Medalha para quem mantém o foco e a determinação mesmo diante dos desafios.",
    desbloqueada: false,
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-200 flex flex-col items-center p-4">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        key={filtro} // para animar ao trocar filtro
      >
        <AnimatePresence>
          {filtrarMedalhas().map((medalha) =>
            medalha.desbloqueada ? (
              ...
              >
                <div
                  className={`w-24 h-24 rounded-full ${medalha.corBg} border-4 ${medalha.corBorder} shadow-lg flex items-center justify-center text-4xl font-bold select-none ${medalha.textoCor}`}
                >
                  {medalha.emoji}
                </div>
                <span
              ...
              <motion.div
                key={medalha.id}
                className="w-20 h-20 rounded-full bg-gray-700 border-2 border-gray-600 flex items-center justify-center text-3xl text-gray-400 select-none"
      ...
      <AnimatePresence>
        {modalAberto && medalhaSelecionada && (
          ...
          >
            <motion.div
              className="bg-gray-800 rounded-lg p-6 max-w-md w-full text-gray-200 relative"
